          ...
          <div className="card">
            <div className="card-content">
              ...
              {loadingStats ? (
                ...
                <p className="text-3xl font-bold text-archaeological-sage">{stats.recentDiscoveries}</p>
              )}
              <p className="text-sm text-archaeological-olive mt-1">
                This month
              </p>
          ...
          <div className="card">
            <div className="card-content">
              ...
              {loadingStats ? (
                ...
                <p className="text-3xl font-bold text-archaeological-gold">{stats.totalPhotos}</p>
              )}
              <p className="text-sm text-archaeological-olive mt-1">
                Total photos
              </p>
