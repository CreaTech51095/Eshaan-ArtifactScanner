...
const verifyAdmin = async (req, res, next) => {
    try {
        ...
        req.user = Object.assign({ uid: decodedToken.uid }, userData);
        next();
    }
    catch (error) {
 ...
 */
router.post('/users/:userId/disable', verifyAdmin, async (req, res) => {
    try {
 ...
 */
router.post('/users/:userId/enable', verifyAdmin, async (req, res) => {
    try {
        const { userId } = req.params;
 ...
 */
router.post('/users/:userId/role', verifyAdmin, async (req, res) => {
    try {
        const { userId } = req.params;
        const { role } = req.body;
